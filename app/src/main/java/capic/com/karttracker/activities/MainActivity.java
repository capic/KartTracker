package capic.com.karttracker.activities;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(view.getContext())
                        ...
                        .setNegativeButton(R.string.create_track_dialog_cancel, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Log.d("MainActivity.onCreate", "dedans1");
                            }
                        })
                        .show();
            }
        ...
        ArrayAdapter<Track> adapter = new TrackAdapter(this, R.layout.track_list_item, tracksList);
